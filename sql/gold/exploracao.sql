...
-- ============================================================================================================
-- CONSULTA 1: Temperatura Média por Cenário e Configuração de Altitude
...
SELECT
    cenario_teste,
    altitude_ft,
    COUNT(DISTINCT motor_nr) AS qtd_motores,
    ROUND(AVG(sensor4), 2) AS temp_media_lpt
FROM (
    SELECT 
        T1.sensor4,
        T2.motor_nr,
        CAST(T2.fd_id AS CHAR) AS cenario_teste,
        CAST(ROUND(T3.setting1, 0) AS CHAR) AS altitude_ft
