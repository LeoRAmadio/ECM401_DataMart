...
\subsection{Camadas Bronze e Silver}
A extração e a transformação inicial dos dados, fundamentais para a criação do DataMart, é realizada nessas camadas: \textbf{Bronze} e \textbf{Silver}.
